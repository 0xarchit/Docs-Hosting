...
label: CityTrack
icon: hubot
description: "Autonomous, event-driven operating system for smart cities with AI agents for urban infrastructure maintenance."
order: 78
tags: [FastAPI, Python, React Native, Next.js, AI, YOLOv8, PostgreSQL, Docker]
---
