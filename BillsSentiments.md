...
3.  **:icon-search: Analysis**: **Gemini 1.5 Flash** (via LangChain) generates summaries and answers RAG queries.
4.  **:icon-layout: Presentation**: Results are displayed on a real-time Interactive Dashboard.

![RAG Workflow](/public/SentimentComments/ragsystemworkflow.png)

## ✨ Key Features {#features}

### 1️⃣ Interactive Dashboard {#dashboard}
...
### 2️⃣ RAG-Powered Chatbot {#chatbot}
...
### 3️⃣ Automated Insight Generation {#insights}
...
### 4️⃣ Detailed Comment Analysis {#comment-analysis}
...
### 5️⃣ Secure Authentication {#authentication}
...
### 6️⃣ Admin & System Health {#admin-health}
